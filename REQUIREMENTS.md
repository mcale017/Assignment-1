...
5. Reference these screenshots for your site:
   ...
   ![Portfolio About](assets/images/REQUIREMENTS/portfolio-about-me.png)

   ![Portfolio Contact](assets/images/REQUIREMENTS/portfolio-contact.png)

   ![Portfolio Gallery](assets/images/REQUIREMENTS/portfolio-gallery.png)
...
6. Dimensions:
   ...
   * Pro-tip: Use the [Page Ruler](https://chrome.google.com/webstore/detail/page-ruler/jlpkojjdgbllmedoapgfodplfhcbnbpn/related?hl=en) extension to measure the size of elements.
   ...
   ![Recommended Dimensions](assets/images/REQUIREMENTS/Recommended-Dimensions.png)
